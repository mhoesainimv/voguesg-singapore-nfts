<template>
  <div class="moja">
    <b-modal content-class="cover-the-modal" hide-footer hide-title  hide-header v-if="the_condition" no-close-on-backdrop modal-header="no" ref="my-modal" centered  id="modal-xl" size="xl" title="Extra Large Modal">
          ...
          <div class="row">
            <div class="col-12 mt-0" style="background-color:#EFECE7;">
              ...
              <div class="container-fluid borderismo-mobile px-0">
                <div class="row">
                  <div class="col-4 align-self-center" :class="the_data.no_sound == true ? 'hidden':''">
...
export default {
  ...
  mounted:function(){
    ...
    this.$nextTick(function () {
      document.getElementById('zorc_video_modal').play();
    });
  },
  created:function(){
